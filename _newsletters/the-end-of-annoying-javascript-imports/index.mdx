...
date: "2021-03-03"
excerpt: "Instead of accessing files in other directories with relative paths we always seem to get the number of wrong, we can use aliases that cover that part for us."
issue: 78
