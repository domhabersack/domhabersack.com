...
The icons all use the same underlying 24&times;24px canvas. The free set offers them as PNGs in three resoultions (@1x, @2x, and @3x). I shared some [constraints behind making them look consistent](/newsletter/the-constraints-behind-consistent-icons) in an issue of [my newsletter](/newsletter).
