...
The feature `prefers-color-scheme` detects if the system is set to a light or dark color scheme. In the same way we’d do [progressive enhancement](/at-supports), we can add styles for a dark mode with this.
