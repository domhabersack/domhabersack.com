...
createdAt: "2015-08-24"
excerpt: "The &-operator in Sass can greatly reduce the typing work required when using BEM in your stylesheets."
tags: ["CSS", "Sass"]
author: dom-habersack
---
BEM, “Block Element Modifier”, is an approach to writing CSS that does away with most of the “cascading” used in CSS. For an excellent primer on the subject, I highly recommend reading [“MindBEMding – getting your head ’round BEM syntax”](https://csswizardry.com/2013/01/mindbemding-getting-your-head-round-bem-syntax/).
