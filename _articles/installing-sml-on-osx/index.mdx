...
tags: ["macOS", "Functional programming"]
createdAt: "2012-07-30"
author: dom-habersack
---
<Flash type="info">
  Are you learning SML/NJ in college? I recorded some free beginner videos that explain how it works. <a href="/standard-ml-for-beginners">Go to the course&nbsp;→</a>
</Flash>
...
The [Homebrew package manager](https://brew.sh/ 'Homebrew package manager for OS X') makes installing SML/NJ on OS X not only much easier, but it will also uninstall all of SML when you are done with it, leaving no dead files on your system.
...
Install Xcode or make sure you are running at least Xcode 4.3.3. Both installation and update are available through the [Mac App Store](https://apps.apple.com/us/app/xcode/id497799835 'Xcode on the Mac App Store'). Xcode is a free download.
