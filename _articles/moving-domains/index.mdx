...
Instead of letting all requests to the old domain end in nothingness, we have to direct them to the new location. If you try to go to [islovely.co/projects](https://domhabersack.com/projects), I have to send you to [domhabersack.com/projects](https://domhabersack.com/projects) instead.
