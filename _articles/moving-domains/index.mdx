...
Instead of letting all requests to the old domain end in nothingness, we have to direct them to the new location. If you try to go to [islovely.co/newsletter](https://islovely.co/newsletter), I have to send you to [domhabersack.com/newsletter](https://domhabersack.com/newsletter) instead.
