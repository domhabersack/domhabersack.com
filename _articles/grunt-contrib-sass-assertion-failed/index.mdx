...
---
Over the last few weeks, I have become a massive fan of [Grunt](https://gruntjs.com/). Amongst other things, it makes development with [Sass](https://sass-lang.com/) and [CoffeeScript](http://coffeescript.org/) much easier by running their compile-processes automatically and reloading the browser via LiveReload. It basically gives you frontend-superpowers.
...
[Homebrew](https://brew.sh/) also updated my installation of Node.js from version 0.10.6 to 0.10.8. However, that new version of Node.js does not currently work with grunt-contrib-sass.
