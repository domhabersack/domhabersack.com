...
Design is a skill like any other, which means we can learn and get better at it. I recommended some [books for getting better at design](/design-books) before. You can also [keep a list of well designed sites](/bookmarking-inspiration) to use for inspiration.
